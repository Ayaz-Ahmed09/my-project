...
const Cards = ({ title, description, viewDetailLink, image, callNowLink }) => {
  ...
  return (
    <div className="relative flex flex-col md:flex-row hover:border-2 border-blue-500 p-6 bg-slate-50 rounded-lg shadow-lg overflow-hidden max-w-full mx-auto">
      {/* Image Section */}
      <img
        src={image}
        alt={title}
        className="w-full h-auto object-cover rounded-lg mb-4 md:mb-0 md:w-1/3 md:mr-6"
      />

const SubCard = ({
  ...
  return (
    <div className="relative flex flex-col lg:flex-row lg:space-x-6 hover:border-2 border-blue-500 p-6 bg-slate-50 rounded-lg shadow-lg overflow-hidden max-w-full mx-auto">
      {/* Image Section */}
      <img
        src={image}
        alt={title}
